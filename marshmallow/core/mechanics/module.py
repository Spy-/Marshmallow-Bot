from marshmallow.core.mechanics.module_component import MarshmallowModuleComponent
...
class MarshmallowModule(MarshmallowModuleComponent):
    ...
    def load_command(self, command_config):
        ...
        cmd_name, cmd = MarshmallowCommand.from_config(self, command_config)
    ...
    def load_event(self, event_config):
        ...
        event_name, event = MarshmallowEvent.from_config(self, event_config)
