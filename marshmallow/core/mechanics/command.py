...
from marshmallow.core.mechanics.moudule_component import MarshmallowModuleComponent
...
class MarshmallowCommand(MarshmallowModuleComponent):
    """
    Represents a Marshmallow Discord command.

    Parameters
    ----------
    module: MarshmallowModule
    ...
    def __init__(self, module, config):
        ...
        self.log = create_logger(self.name.uppper())
        self.module = module
        self.cfg = {}
        self.cache = {}
