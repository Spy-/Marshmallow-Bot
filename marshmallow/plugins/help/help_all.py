...
async def help_all(cmd, message, args):
    if args:
        ...
        response.set_author(name='Marshmallow Bot Commands', icon_url=bot_image, url='https://github.com/Spy-/Marshmallow-Bot/blob/master')
