...
async def botinformation(cmd, message, args):
    ...
    marshmallow_image = 'https://i.imgur.com/mGyqMe1.png'
    ...
    if version_data['beta']:
        full_version += ' Beta'
    marshmallow_title = f'Marshmallow: v{full_version}  {version_data["codename"]}'
    ...
    response.set_author(name=marshmallow_title, icon_url=marshmallow_image, url=support_url)
